...
const Disclosures = () => (
  <div className="container mx-auto px-[10%] py-16 min-h-screen">
    <section className="mb-8">
      <h2 className="text-4xl md:text-5xl font-bold  text-primary-600 dark:text-primary-400 mb-8 text-left self-start">OUR VISION</h2>
      <p className="mb-4 text-neutral-900 dark:text-neutral-400">To protect the interests by enabling them to understand the risks involved and invest in fair, transparent, secure market, and to get services in a timely and efficient manner.</p>
    </section>
    <section className="mb-8">
      <h2 className="text-2xl font-semibold mb-2 text-primary-600 dark:text-primary-400">OUR MISSION</h2>
      <ul className="list-disc pl-6 space-y-2 text-neutral-900 dark:text-neutral-400">
    ...
    <section className="mb-8">
      <h2 className="text-2xl font-semibold mb-2">INVESTORS have RIGHT to:</h2>
      <ul className="list-disc pl-6 space-y-2 text-neutral-900 dark:text-neutral-400">
    ...
    <section className="mb-8">
      <h2 className="text-2xl font-semibold mb-2 text-primary-600 dark:text-primary-400">INVESTORS have RESPONSIBILITY to:</h2>
      <ul className="list-disc pl-6 space-y-2 text-neutral-900 dark:text-neutral-400">
        ...
        <li>Ensure that their accounts operated only for their own benefit.</li>
      </ul>
    </section>
    <section className="mb-8">
      <h2 className="text-2xl font-semibold mb-2 text-primary-600 dark:text-primary-400">DO's for Investors:</h2>
      <ul className="list-disc pl-6 space-y-2 text-neutral-900 dark:text-neutral-400">
    ...
    <section className="mb-8">
      <h2 className="text-2xl font-semibold mb-2">DONT's for Investors:</h2>
      <ul className="list-disc pl-6 space-y-2 text-neutral-900 dark:text-neutral-400">
