...
export const metadata = {
  title: 'Disclaimers | Trust Wealthy Capital Advisors',
  description: 'Review the disclaimers and legal information for Trust Wealthy Capital Advisors (TWCA).'
};
  ...
  <>
    <div className="container mx-auto px-[10%] py-16 min-h-screen text-neutral-600 dark:text-neutral-400">
      ...
      <ul className="list-disc pl-6 space-y-4 text-lg">
        ...
        <li>Everything posted on social media (Twitter/Facebook/Telegram/YouTube channel) is for education / illustration purposes and should not be counted as recommendations or investment advice.</li>
      </ul>
    </div>
  </>
);
